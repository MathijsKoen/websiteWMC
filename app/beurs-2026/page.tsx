...
const BEURS = {
  title: 'WMC Beurs 2026',
  subtitle: 'Modelspoor Tentoonstelling',
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6 mb-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-white/40 mb-0.5">Datum</p>
                  <p className="text-sm font-bold text-white">{BEURS.date}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#cc0000] flex items-center justify-center shrink-0">
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-white/40 mb-0.5">Tijden</p>
                  <p className="text-sm font-bold text-white">{BEURS.time}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#cc0000] flex items-center justify-center shrink-0">
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-white/40 mb-0.5">Locatie</p>
                  <p className="text-sm font-bold text-white">{BEURS.location}</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-6">
          <div className="flex flex-wrap gap-8 md:gap-12 items-center justify-between">
            <div className="flex flex-wrap gap-8 md:gap-12">
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/60 mb-0.5">Datum</p>
                <p className="text-sm font-black text-white" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>{BEURS.date}</p>
              </div>
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/60 mb-0.5">Openingstijden</p>
                <p className="text-sm font-black text-white" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>{BEURS.time}</p>
              </div>
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/60 mb-0.5">Locatie</p>
                <p className="text-sm font-black text-white" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>{BEURS.location}</p>
              </div>
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/60 mb-0.5">Toegang</p>
                <p className="text-sm font-black text-white" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>{BEURS.admission}</p>
              </div>
            </div>
            {layouts.length > 0 && (
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          {layouts.length === 0 ? (
            <div className="bg-white border border-[#e2e2e2] p-16 text-center">
              ...
              <p
                className="font-black text-xl text-[#1a1c1c] mb-2"
                style={{ fontFamily: 'Space Grotesk, sans-serif' }}
              >
              ...
              {[
                {
                  ...
                  label: 'Datum',
                  value: BEURS.date,
                  sub: 'Noteer het alvast in je agenda',
                },
                {
                  icon: Clock,
                  label: 'Openingstijden',
                  value: BEURS.time,
                  sub: 'Zorg dat je op tijd bent',
                },
                {
                  icon: MapPin,
                  label: 'Locatie',
                  value: BEURS.location,
                  sub: BEURS.venue.replace('\n', ', '),
                },
              ].map(({ icon: Icon, label, value, sub }) => (
                <div key={label} className="flex items-start gap-5 p-6 border border-[#e2e2e2] bg-[#f9f9f9]">
                  ...
                  <div>
                    ...
                    <p
                      className="font-black text-lg text-[#1a1c1c] leading-tight"
                      style={{ fontFamily: 'Space Grotesk, sans-serif' }}
                    >
                      {value}
                    </p>
            ...
            <div className="bg-white/5 border border-white/10 p-8">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                <a
                  ...
                  className="text-[#cc0000] hover:text-white transition-colors font-bold"
                >
                  info@dewmc.nl
                </a>
              </p>
