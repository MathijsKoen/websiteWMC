  ...
  return (
    <section className="bg-[#f9f9f9] min-h-[80vh] flex items-center justify-center">
      <div className="max-w-md mx-auto px-6 text-center">
        <div className="font-headline font-black text-[120px] leading-none tracking-tighter text-[#e2e2e2] mb-4">
          404
        </div>
        <div className="flex justify-center mb-6">
          <Train size={40} className="text-[#cc0000]" />
        </div>
        <h1 className="font-black text-3xl tracking-tighter text-[#1a1c1c] mb-4">
