                ...
                >
                  ...
                  <div className="relative z-10 p-8 md:p-10">
                    ...
                    <p className="text-white/60 text-sm leading-relaxed mb-7 max-w-xs">
                      De WMC organiseert een modelspoor- en modelbouwevenement. Noteer het alvast in je agenda!
                    </p>
                    ...
                    <div className="flex flex-col gap-3 mb-8">
                      {[
                        ...
                        { icon: Train,    text: 'Banen uit Nederland, België, Duitsland en Frankrijk' },
                      ].map(({ icon: Icon, text }) => (
